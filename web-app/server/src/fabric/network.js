...
exports.connectionToNetwork = async function (userName) {
...
exports.registerUser = async function(userId, registrarId, firstName, lastName){
  ...
  if (!registrarId || !userId || !firstName || !lastName){
    let response = {};
